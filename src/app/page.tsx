	...
	return (
		<>
			<MaxWidthWrapper className="mt-28 mb-12 sm:mt-40 flex flex-col items-center justify-center text-center">
				...
				<p className="mt-5 max-w-prose text-zinc-700m sm:text-lg">
					PDF Chat allows you to have conversations with any pfd document. By Simply uploading your
					...
					<div>
						<div className="mx-auto max-w-6xl px-6 lg:px-8">
							<div className="mt-16 flow-root sm:mt-24">
								<div className="-m-2 rounded-xl bg-gary-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
									<Image
				...
				<div className="mb-12 px-6 lg:px-8">
					<div className="mx-auto max-w-2xl sm:text-center">
						...
						<p className="mt-4 text-lg text-gray-600">
							chatting with your PDF has never been easier than with PDF Chat
						</p>
					</div>
				</div>
				<ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
					...
					<li className="md:flex-1">
						<div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
							...
							<span className="mt-2 text-zinc-700">
								It&apos;s that simple. Try out pdf Chat today - it really takes less than a minute.
							</span>
						</div>
					</li>
				</ol>
